...
namespace libff
{
    ...
    bool
    edwards_Fq3_conic_coefficients::operator==(const edwards_Fq3_conic_coefficients &other) const
    {
        return (this->c_ZZ == other.c_ZZ && this->c_XY == other.c_XY && this->c_XZ == other.c_XZ);
    }
    ...
    edwards_GT edwards_final_exponentiation(const edwards_Fq6 &elt)
    {
        ...
        const edwards_Fq6 elt_to_first_chunk = edwards_final_exponentiation_first_chunk(elt,
                                                                                        elt_inv);
        const edwards_Fq6 elt_inv_to_first_chunk = edwards_final_exponentiation_first_chunk(elt_inv,
                                                                                            elt);
        edwards_GT result = edwards_final_exponentiation_last_chunk(elt_to_first_chunk,
                                                                    elt_inv_to_first_chunk);
    ...
    struct extended_edwards_G1_projective
    {
        ...
        void test_invariant() { assert(T * Z == X * Y); }
    };
                                               ...
                                               edwards_Fq3_conic_coefficients &cc)
    {
        ...
        const edwards_Fq3 H = edwards_G2::mul_by_a(
